      ...
      <div className={style.container_jellyfish} id="jellyfish">
        ...
        <div className={style.content_main}>
          <div className={style.content_info}>
            ...
            <p>
              2. Володіє унікальною здатністю до безсмертя.Вона може здійснювати
              процес, що дозволяє їй перетворювати одну клітину в іншу і,
              практично, безкінечно відновлювати свою життєву циклічність.
            </p>
            <p>
            ...
            <p>
              4. Зустрічається в різних частинах світу. Може бути знайдена в
              тропічних і помірних водах уздовж узбережжя та у відкритому
              океані.
            </p>
