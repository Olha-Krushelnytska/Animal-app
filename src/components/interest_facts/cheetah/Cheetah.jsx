      ...
      <div className={style.container_cheetah} id="cheetah">
        ...
        <div className={style.content_main}>
          <div className={style.content_info}>
            ...
            <p>
              3. Гепарди є хорошими мисливцями, використовують свою швидкість та
              маневреність для спіймання своєї здобичі.
            </p>
            <p>
              4. Гепарди є видом, що перебуває під загрозою, і їх чисельність
              значно зменшилася.
            </p>
          </div>
        </div>
